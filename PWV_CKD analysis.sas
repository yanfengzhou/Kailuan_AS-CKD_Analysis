/*import data, the PWV_CKD database includes 33516 baPWV records and time-dependent covariates*/
...
/*model 1*/
proc phreg data=PWV_baseline covs(aggregate);
class pwv5(ref='4')  ;
...
/*Table 2 baPWV over time*/
proc sort data=PWV_CKD;by ID pwv_measdate;run;
data PWV_CKD;set PWV_CKD;
by ID;
if first.ID then num2=0;
num2+1;
run;
data PWV_over;set PWV_CKD;
if num2^=1;
run;
proc rank data=PWV_over out=PWV_over group=5;
var pwv;
ranks pwv_over5;
run;

proc means data=PWV_over n nmiss mean std min max sum;
var pwv;
class pwv_over5;
run;
proc freq data=PWV_over;
table pwv_over5*ckd;
run;
/*model 1*/
proc phreg data=PWV_over covs(aggregate);
class pwv_over5(ref='4')  ;
model (start,stop)*ckd(0)=pwv_over5 
/rl ties=exact risklimits;id ID;
output out=res  ressch=sch;
run;
/*model 2*/
proc phreg data=PWV_over covs(aggregate);
class pwv_over5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1') 
hypertension(ref='1') diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  ;
model (start,stop)*ckd(0)=pwv_over5 age map bmi  sex marri  edu
smoke alcohol physical salt tg ldl hdl fbg crp egfr
/rl ties=exact risklimits;id ID;
output out=res  ressch=sch;
run;
...
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1') 
hypertension(ref='1') diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  anemia(ref='1');
model (start,stop)*ckd(0)=pwv_over5 age map bmi sex 
smoke alcohol physical salt tg ldl hdl fbg crp egfr
...
/*model 1*/
proc phreg data=pwv_pro covs(aggregate);
...
proc phreg data=pwv_pro covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1') /*bmifl(ref='1')*/
hypertension(ref='1') diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1') anemia(ref='1') ;
model (start, stop)*ckd(0)=pwv_progression5 pwv age map bmi  sex 
smoke alcohol physical salt tg ldl hdl fbg crp egfr
hypertension diabetes  edu anti_hy anti_dia marri statin anemia
...
/*baseline pwv*/
data g1;set pwv_pro;if pwv<1400 then yz1=1;if pwv>=1400 then yz1=2;run;
proc freq data=g1;table yz1*ckd;run;
/*P for interaction*/
proc phreg data=g1 covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1') 
hypertension(ref='1')  diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  anemia(ref='1') ;
...
proc phreg data=g1a covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1') 
hypertension(ref='1')  diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  anemia(ref='1');
model (start, stop)*ckd(0)=pwv_progression5 pwv age map bmi  sex 
...
proc phreg data=g1b covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1') 
hypertension(ref='1')  diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  anemia(ref='1') ;
model (start, stop)*ckd(0)=pwv_progression5 pwv age map bmi  sex 
...
/*bmi*/
data g1;set pwv_pro;if bmi<23 then yz2=1;if bmi>=23 then yz2=2;run;
...
output out=res  ressch=sch;
run;
data g1a;set pwv_pro;if sex=1;run;
proc phreg data=g1a covs(aggregate);
...
output out=res  ressch=sch;
run;
data g1b;set pwv_pro;if sex=2;run;
proc phreg data=g1b covs(aggregate);
class pwv_progression5(ref='4')  marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1')  anemia(ref='1')
hypertension(ref='1')  diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  ;
...
/*age*/
data g1;set pwv_pro;if age<60 then yz4=1;if age>=60 then yz4=2;run;
...
/*P for interaction*/
proc phreg data=h1 covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1')  anemia(ref='1')
...
proc phreg data=h1a covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1')  anemia(ref='1')
hypertension(ref='1')  anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  ;
model (start, stop)*ckd(0)=pwv_progression5 pwv age map bmi  sex 
...
proc phreg data=h1b covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1')  anemia(ref='1')
hypertension(ref='1')  anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  ;
model (start, stop)*ckd(0)=pwv_progression5 pwv age map bmi  sex 
...
proc phreg data=h1c covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1')  anemia(ref='1')
hypertension(ref='1')  anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  ;
model (start, stop)*ckd(0)=pwv_progression5 pwv age map bmi  sex 
...
output out=res  ressch=sch;
run;
data g1a;set pwv_pro;if hypertension=0;run;
proc phreg data=g1a covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1')  anemia(ref='1')
...
output out=res  ressch=sch;
run;
data g1b;set pwv_pro;if hypertension=1;run;
proc phreg data=g1b covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1')  anemia(ref='1')
diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  ;
...
/*model 3*/
proc phreg data=pwv_pro1 covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1') 
hypertension(ref='1') diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1') anemia(ref='1') ;
model (start,stop)*ckd(0)=pwv_progression5 pwv age map bmi  sex 
...
run;
/*model 3*/
proc phreg data=pwv_pro2 covs(aggregate);
class pwv_progression5(ref='4')  sex(ref='1') marri(ref='1') edu(ref='1') 
salt(ref='1') smoke(ref='1') alcohol(ref='1') physical(ref='1') anemia(ref='1')
hypertension(ref='1') diabetes(ref='1') anti_hy(ref='1') anti_dia(ref='1') statin(ref='1')  ;
